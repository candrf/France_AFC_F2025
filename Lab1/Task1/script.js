...
// Step 1: Make a function called calculate age that has a parameter called year
function calculateAge(year) {
    // Step 2: Get the current year at the time of use from Date function
